...
!define URL http://www.FidelCastro.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/FidelCastro.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\FidelCastro-qt.exe
...
OutFile FidelCastro-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/FidelCastro-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/FidelCastrod.exe
    ...
    #Delete /REBOOTOK $INSTDIR\FidelCastro.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\FidelCastro-qt.exe
