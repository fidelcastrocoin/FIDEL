...
int CNetAddr::GetReachabilityFrom(const CNetAddr *paddrPartner) const
{
    ...
    case NET_IPV6:
        ...
        case NET_IPV4:   return REACH_IPV4;
        case NET_IPV6:   return fTunnel ? REACH_IPV6_WEAK : REACH_IPV6_SFidelCastroG; // only prefer giving our IPv6 address if it's not tunnelled
        }
    case NET_TOR:
        switch(ourNet) {
        default:         return REACH_DEFAULT;
