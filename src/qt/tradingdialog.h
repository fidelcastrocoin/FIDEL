...
private slots:
    ...
    void on_BuyFidelCastro_clicked();
    void on_SellFidelCastroBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputFidelCastro_textChanged(const QString &arg1);
    ...
    QString BuyFidelCastro(QString OrderType, double Quantity, double Rate);
    QString SellFidelCastro(QString OrderType, double Quantity, double Rate);
